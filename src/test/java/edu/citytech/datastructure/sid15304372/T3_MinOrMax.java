...
import edu.citytech.datastructure.sid15304372.bst.DefaultSearch;
...
class T3_MinOrMax {
	...
	@Test
	@DisplayName("Custom Max Method for Customer Search")
	void max() {		
		var bst = new BinarySearchTree<Product>(new CustomSearchEngine<>());	
	...
	void minD() {		
		var bst = new BinarySearchTree<Product>(new DefaultSearch());
